...
export const DisneyPillLogo: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 90 25" xmlns="http://www.w3.org/2000/svg" {...props}><text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontSize="18" fontWeight="bold" fontFamily="sans-serif" fill="currentColor">Disney+</text></svg>
);

export const HuluPillLogo: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 70 25" xmlns="http://www.w3.org/2000/svg" {...props}><text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontSize="18" fontWeight="bold" fontFamily="sans-serif" fill="currentColor">hulu</text></svg>
);

export const ESPNPillLogo: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 70 25" xmlns="http://www.w3.org/2000/svg" {...props}><text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontSize="18" fontWeight="bold" fontFamily="sans-serif" fill="currentColor">ESPN</text></svg>
);

export const DisneyBrandLogo: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 100 40" xmlns="http://www.w3.org/2000/svg" {...props}><text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontSize="28" fontFamily="cursive" fill="currentColor">Disney</text></svg>
);

export const PixarBrandLogo: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 100 40" xmlns="http://www.w3.org/2000/svg" {...props}><text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontSize="26" fontWeight="bold" fontFamily="sans-serif" fill="currentColor">PIXAR</text></svg>
);

export const MarvelBrandLogo: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 120 40" xmlns="http://www.w3.org/2000/svg" {...props}><text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontSize="26" fontWeight="bold" fontFamily="sans-serif" fill="currentColor">MARVEL</text></svg>
);

export const StarWarsBrandLogo: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 180 40" xmlns="http://www.w3.org/2000/svg" {...props}><text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontSize="24" fontWeight="bold" fontFamily="sans-serif" fill="currentColor">STAR WARS</text></svg>
);

export const NationalGeographicBrandLogo: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 300 40" xmlns="http://www.w3.org/2000/svg" {...props}><text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontSize="20" fontWeight="bold" fontFamily="sans-serif" fill="currentColor">NATIONAL GEOGRAPHIC</text></svg>
);
