...
export const HomeIcon: React.FC<IconProps & { isActive: boolean }> = ({ className, isActive }) => (
    <span className={className} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <i className={`${isActive ? 'fi fi-sr-house-chimney' : 'fi fi-rr-house-chimney'} text-2xl`}></i>
    </span>
);

export const FilmIcon: React.FC<IconProps & { isActive: boolean }> = ({ className, isActive }) => (
    <span className={className} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <i className={`${isActive ? 'fi fi-sr-popcorn' : 'fi fi-rr-popcorn'} text-2xl`}></i>
    </span>
);

export const TVIcon: React.FC<IconProps & { isActive: boolean }> = ({ className, isActive }) => (
    <span className={className} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <i className={`${isActive ? 'fi fi-sr-screen' : 'fi fi-rr-screen'} text-2xl`}></i>
    </span>
);

export const LikesIcon: React.FC<IconProps & { isActive: boolean }> = ({ className, isActive }) => (
     <span className={className} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <i className={`${isActive ? 'fi fi-sr-heart' : 'fi fi-rr-heart'} text-2xl`}></i>
    </span>
);
...
// --- START: NEW BRAND LOGO COMPONENTS ---
