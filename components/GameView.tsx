...
export type Game = 'trivia' | 'six-degrees' | 'guess-poster' | 'box-office' | null;
          ...
          <div className="text-center animate-text-focus-in">
            ...
            <div className="flex flex-wrap items-stretch justify-center gap-8">
              ...
              <GameCard
                ...
                description="Higher or lower: can you keep the streak alive by guessing worldwide grosses?"
